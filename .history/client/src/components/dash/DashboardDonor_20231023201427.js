...
const DashboardDonor = () => {
  ...
  <div className="container-fluid dashboard-main">
    ...
    <div className="container d-flex justify-content-center align-items-center flex-column">
      <h1 className="home-subtitle text-center" style={{ color: 'black', marginTop: "100px", marginButton: "100px"}}>
        ...
        <div className="row mb-5">
          ...
          <div className="container rating-widget col-6">
            <div className="rating-widget-value ">
              ...
              <h3 className="rating-widget-value-text "> {user && user.rating && user.rating.length > 0 ? findAverage(user.rating) : 'N/A'}</h3>
            </div>
            <div className="rating-widget-title">
              <div className="rating-widget-title">
