...
const DashboardVolunteer = () => {
  ...
  function minutesToHoursAndMinutes(minutes) {
    ...
    if (hours === 0) {
      ...
      return `${hours} hours ${Math.round(remainingMinutes * 100)/100} mins`;
    }
  }
          ...
          <div className="row mb-5">
            <div className="container rating-widget col-6">
              ...
              <h3 className="rating-widget-value-text">
                {user && user.service_hours
                  ? minutesToHoursAndMinutes(user.service_hours)
                  : "0 mins"}
              </h3>
              </div>
            ...
            <div className="container rating-widget col-6">
              <div className="rating-widget-value">
              <h3 className="rating-widget-value-text">
                {user && user.items_delivered !== null ? user['items_delivered'] : 0}
              </h3>
              </div>
              <div className="rating-widget-title">
                <div className="rating-widget-title">
                  <h3 className="rating-widget-title-text text-center">Items Delivered</h3>
                </div>
              </div>
            </div>
          </div>
