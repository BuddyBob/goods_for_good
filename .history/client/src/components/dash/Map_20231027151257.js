...
const Map = (props) => {
  ...
  return (
    <div>
      <button className="addpopup-close" style={{zIndex: '5001', left:"28%", top: '40px'}} onClick={() => {console.log("yo")}}>
      <AiOutlineClose style={{zIndex: '5001', left:"28%", top: '40px'}} className="addpopup-close" />
      </button>
