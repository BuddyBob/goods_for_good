...
const AddPopup = ({onClose}) => {
  ...
  const [currentLocation, setCurrentLocation] = useState('Your Existing Location');
    ...
    <div className="container pop-container">
      <div className="center-content">
        ...
        <div className='row add-location'>
          <input type="text" className="add-input" placeholder="Location" ref={locationRef} value={currentLocation} onChange={handleLocationChange} />
        </div>
