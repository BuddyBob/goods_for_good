...
const Map = (props) => {
  ...
  return (
    <div>
      ...
      <GoogleMapExample
        containerElement={<div style={{ background: "#eeeeee", padding:"30px", paddingTop: "90px", borderRadius:"10px",   height: `100%`, width: '30%', position: 'absolute', zIndex: '5000', left: '10px', top: '10px'}}  />}
