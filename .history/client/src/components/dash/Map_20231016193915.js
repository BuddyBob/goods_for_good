...
const Map = (props) => {
  ...
  return (
    <div>
      <AiOutlineClose className="addpopup-close" onClick={() => props.onClose()} />
      <GoogleMapExample
        containerElement={<div style={{ background: "#eeeeee", padding:"20px",   height: `500px`, width: '600px', position: 'absolute', zIndex: '9999', left: '10px', top: '10px'}}  />}
