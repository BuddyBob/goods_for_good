...
function Items(type) {
  ...
  const handleGoogleMapsDirLink = (e, donorLocationInput, doneeLocationInput) => {
    e.preventDefault();
            ...
            <div key={itemIds[index]} className="card-item mb-4">
                ...
                <div className="card-body">
                  ...
                  {type.type === 'donee' ? (
                    ...
                    <p className="card-text" onClick={(e) => handleGoogleMapsDirLink(e, item.location, item.donee_location)}>
                      <strong>Directions</strong> <GiPathDistance/> {item.donee_location}
                    </p>
                  ) : null}
