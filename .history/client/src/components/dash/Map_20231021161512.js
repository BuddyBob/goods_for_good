...
const Map = (props) => {
  ...
  return (
    <div>
      ...
      <GoogleMapExample
        containerElement={<div style={{ background: "#eeeeee", padding:"30px", paddingTop: "80px", borderRadius:"10px",   height: `90%`, width: '50%', position: 'absolute', zIndex: '5000', left: '10px', top: '10px'}}  />}
