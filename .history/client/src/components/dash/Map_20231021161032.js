...
const Map = (props) => {
  ...
  return (
    <div>
      ...
      <GoogleMapExample
        containerElement={<div style={{ background: "#eeeeee", padding:"30px", paddingTop: "80pxs" borderRadius:"10px",   height: `950px`, width: '600px', position: 'absolute', zIndex: '5000', left: '10px', top: '10px'}}  />}
