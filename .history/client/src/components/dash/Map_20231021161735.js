...
const Map = (props) => {
  ...
  return (
    <div>
      <AiOutlineClose style={{zIndex: '5001', left:"28%", top: '40px'}} className="addpopup-close" onClick={() => props.onClose()} />
      <div className="google-map-data">
        <div className="col">
          <p className="maps-data-text text-center">Distance: {distance}</p>
        </div>
        <div className="col">
          <p className="maps-data-text text-center">Service Hours: 10</p>
        </div>
      </div>
      <GoogleMapExample
