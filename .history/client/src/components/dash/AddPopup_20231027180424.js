  ...
  return (
    <div className="container pop-container1">
      ...
      <div className="center-content">
        <AiOutlineClose style={{"top": "10px"}} className="add-popup-close2" onClick={() => onClose()} />
        <div className="row add-image-container">
          {isLoading ? (
            <div class="spinner-border text-warning" role="status" style={{"position": "absolute", "top": "50%", "left": "50%", "right": "50%"}}>
