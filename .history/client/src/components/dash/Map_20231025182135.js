...
const Map = (props) => {
  ...
  return (
    <div>
      {/* <AiOutlineClose style={{zIndex: '5001', left:"28%", top: '40px'}} className="addpopup-close" onClick={console.log("yo")} /> */}
      <button type="button" className="close" aria-label="Close" style={{zIndex: '5001', left:"28%", top: '40px'}} onClick={() => props.onClose()}>
