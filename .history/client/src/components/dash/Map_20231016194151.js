...
const Map = (props) => {
  ...
  return (
    <div>
      <AiOutlineClose style={{zIndex: '5001',  left: '590px', top: '10px'}} className="addpopup-close" onClick={() => props.onClose()} />
      <GoogleMapExample
        containerElement={<div style={{ background: "#eeeeee", padding:"20px", borderRadius:"10px",   height: `500px`, width: '600px', position: 'absolute', zIndex: '5000', left: '10px', top: '10px'}}  />}
