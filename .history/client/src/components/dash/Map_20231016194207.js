...
const Map = (props) => {
  ...
  return (
    <div>
      <AiOutlineClose style={{zIndex: '5001',  left: '585px', top: '15px'}} className="addpopup-close" onClick={() => props.onClose()} />
      <GoogleMapExample
        containerElement={<div style={{ background: "#eeeeee", padding:"30px", borderRadius:"10px",   height: `500px`, width: '600px', position: 'absolute', zIndex: '5000', left: '10px', top: '10px'}}  />}
