          ...
          <div className="row mb-5">
            <div className="container rating-widget col-6">
              <div className="rating-widget-value">
                <h3 className="rating-widget-value-text">{find_average(user.rating)}</h3>
              </div>
            ...
            <div className="container rating-widget col-6">
              <div className="rating-widget-value ">
                <h3 className="rating-widget-value-text ">{user && user.service_hours && user.rating.length > 0 ? findAverage(user.rating) : 'N/A'}</h3>
              </div>
              <div className="rating-widget-title">
                <div className="rating-widget-title">
