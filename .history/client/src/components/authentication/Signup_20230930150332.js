                ...
                <div className="container-fluid h-custom">
                    <div className="row d-flex justify-content-center align-items-center h-100">
                        ...
                        <div className="col-md-8 col-lg-6 col-xl-4 offset-xl-1 auth-form">
                            ...
                            AIzaSyClyIN7tY--ySC4EENZWWqBsdbq0ZlcSgA
                            <div className="form-outline mb-4">
                            <input type="text" id="locationInput" className="form-control form-control-lg"
                                placeholder="Enter your location" value={locationInput} onChange={(e) => setLocationInput(e.target.value)} />
