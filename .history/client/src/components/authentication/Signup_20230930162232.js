                ...
                <div className="container-fluid h-custom">
                    <div className="row d-flex justify-content-center align-items-center h-100">
                        ...
                        <div className="col-md-8 col-lg-6 col-xl-4 offset-xl-1 auth-form">
                            ...
                            <div className="form-outline mb-3">
                                <input type="text" id="form3Example4" className="form-control form-control-lg" placeholder="Enter password" value={localStorage.getItem("location")} onChange={(e) => setLocationInput(e.target.value)} />
