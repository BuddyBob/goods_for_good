                    ...
                    <div className="row d-flex justify-content-center align-items-center h-100">
                        ...
                        <div className="col-md-8 col-lg-6 col-xl-4 offset-xl-1 auth-form">
                            ...
                            <div className="text-center text-lg-start mt-4 pt-2">
                                <button type="button" className="btn btn-default register-button" onClick={(e) => handleRegistration(e, email, password, location.userType)}>Sign Up</button>
