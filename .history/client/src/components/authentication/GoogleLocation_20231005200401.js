...
function AddressSelection() {
  const CONFIGURATION = {
    ...
    "mapsApiKey": "YOUR_API_KEY", // Replace with your Google Maps API key
    "capabilities": {
  ...
  useEffect(() => {
    ...
    script.src = `https://maps.googleapis.com/maps/api/js?key=${CONFIGURATION.mapsApiKey}&libraries=places&callback=initMap&solution_channel=GMP_QB_addressselection_v1_cABC`;
    script.async = true;
    script.defer = true;
