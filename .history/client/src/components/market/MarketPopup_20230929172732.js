        ...
        stepNumber == 1 && (
          <div className="marketPopup__step1">
            ...
            <div className="rod-flex flex-row-reverse">
              <input type="button" className="p-2 btn btn-primary" value="Yes" onClick={() => setStepNumber(2)}/>
              <input type="button" className="p-2 btn btn-primary" value="No" onClick={() => onClose()}/>
            </div>
          </div>
        )
      }
