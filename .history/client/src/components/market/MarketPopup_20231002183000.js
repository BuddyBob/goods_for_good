        ...
        stepNumber == 1 ? (
          <div className="marketPopup__step">
            ...
            <div className="row confirmation-buttons">
              <input type="button" className="col-8 btn btn-primary c" value="Yes" onClick={() => setStepNumber(2)}/>
              <input type="button" className="col-8 btn btn-primary" value="No" onClick={() => onClose()}/>
            </div>
          </div>
        ) : stepNumber == 2 ? (
          <>
