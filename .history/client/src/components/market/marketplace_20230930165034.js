...
const Marketplace = () => {
  ...
  return (
    <div className="container-fluid marketplace-main">
      <Navbar />
      <h1 className="home-subtitle" style={{ color: 'black', marginTop: '20px', marginBottom: '40px' }}>
        Marketplace
      </h1>
      ...
      <div className="container marketplace-container">
        ...
        <div className="row cards-item-row">
          {items.map((item, index) => (
            <div className="col-md-4" key={itemIds[index]}>
