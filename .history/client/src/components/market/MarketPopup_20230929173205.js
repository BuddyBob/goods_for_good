    ...
    <div className="marketPopup">
      {
        stepNumber == 1 && (
          <div className="marketPopup__step1">
            ...
            <div className="row">
              <input type="button" className="col-4 btn btn-primary" value="Yes" onClick={() => setStepNumber(2)}/>
              <input type="button" className="col-4 btn btn-primary" value="No" onClick={() => onClose()}/>
            </div>
          </div>
        )
      }
