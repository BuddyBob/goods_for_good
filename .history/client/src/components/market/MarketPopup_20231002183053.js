        ...
        stepNumber == 1 ? (
          <div className="marketPopup__step">
            ...
            <div className="row confirmation-buttons">
              <input type="button" className="col-6 btn btn-primary mr-2" style={{"width": "100px"}} value="Yes" onClick={() => setStepNumber(2)}/>
              <input type="button" className="col-6 btn btn-primary" style={{"width": "100px"}}  value="No" onClick={() => onClose()}/>
            </div>
          </div>
        ) : stepNumber == 2 ? (
          <>
          ...
          <input type="button" className="col-3 btn btn-primary" value="Yes" onClick={() => setStepNumber(3)}/>
          </>
        ) : stepNumber == 3 ? (
          <>
            <div className="marketPopup__step">
