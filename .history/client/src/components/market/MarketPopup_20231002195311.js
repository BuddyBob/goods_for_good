          ...
          <div className="card">
            <div className="card-body">
              ...
              <div className="row confirmation-buttons">
                <input type="button" className="col-5 btn btn-primary" value="Yes" onClick={() => setStepNumber(2)}/>
                <input type="button" className="col-5 btn btn-primary" value="No" onClick={() => onClose()}/>
              </div>
            </div>
          </div>
        ) : stepNumber == 2 ? (
