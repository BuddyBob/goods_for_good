...
const MarketPopup = ({onClose,itemId, item}) => {
  ...
  const [pickupLocation, setPickupLocation] = useState(localStorage.getItem("location"));
              ...
              <h2 className="marketPopup__step__title">Item Pickup Location</h2>
                <form>
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value={pickupLocation} onChange={handleInputChange}/>
                  </div>
                </form>
            </div>
