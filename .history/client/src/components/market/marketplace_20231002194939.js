...
const Marketplace = () => {
  ...
  const showPopup = (itemId, title, description, location, donee_location, status, owner) => {
        ...
        <div className="cards-row">
          {items.map((item, index) => (
            ...
            <div className="status">
              ...
              <div className="card-item mb-4" onClick={() => showPopup(itemIds[index], item.title, item.description, item.location, item.donee_location, item.status, item.owner)}>
                ...
                <div className="card-body">
                  ...
                  { localStorage.getItem("userType") == "donee" || localStorage.getItem("userType") == "doner" ? (
