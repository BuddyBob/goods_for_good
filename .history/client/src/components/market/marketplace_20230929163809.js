  ...
  return (
    <div className="container d-flex align-items-center marketplace-main">
      ...
      <div className="container marketplace-container">
            {addPopup && <AddPopup onClose={() => setAddPopup(false)} itemId={selectedItemId} item={selectedItem} />}
            <div className="row cards-item-row">
                {items.map((item, index) => (
                    <div className="col">
                        ...
                        <div key={itemIds[index]} className="card-item" onClick={() => showPopup(itemIds[index], item.title, item.description, item.location, item.status)}>
