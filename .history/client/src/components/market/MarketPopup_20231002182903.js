        ...
        stepNumber == 1 ? (
          <div className="marketPopup__step">
            ...
            <div className="row confirmation-buttons">
              <input type="button" className="col-6 btn btn-primary mr-2 c" value="Yes" onClick={() => setStepNumber(2)}/>
              <input type="button" className="col-6 btn btn-primary ml-2" value="No" onClick={() => onClose()}/>
            </div>
          </div>
        ) : stepNumber == 2 ? (
          <>
