                    ...
                    <div className="row">
                        <div className="col-sm">
                            <div className="faq-card">
                                ...
                                <p className="card-description" style={{width: "95%"}}> Donors can upload their items to our marketplace, providing pictures, item categories, and locations. PEH users can then browse and request the items they need. </p>
                            </div>
                        </div>
                        <div className="col-sm">
                            <div className="faq-card">
