                    ...
                    <div className="row">
                        <div className="col-12">
                            <p className="home-description">
                                Welcome to Goods for Good, the platform bridging the gap between those in need and the people willing to help. By uniting communities through acts of kindness, we're making a real difference for individuals at the risk of experiencing homelessness
                            </p>
                        </div>
                    </div>
