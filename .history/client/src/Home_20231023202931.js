                    ...
                    <div className="row">
                        ...
                        <div className="col-sm">
                            <div className="faq-card">
                                ...
                                <p className="card-description" style={{width: "95%"}}> By signing up as a volunteer, high schoolers will be able to see current transactions and offer their support in picking up and dropping off donated items.</p>
                            </div>
                        </div>
                    </div>
                </div>
