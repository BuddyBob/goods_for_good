                    ...
                    <div className="row">
                        <div className="col-12">
                            <p className="home-description">
                                Welcome to Homeless Connect, the platform bridging the gap between those in need and the people willing to help. By uniting communities through acts of kindness, we're making a real difference for individuals.
                            </p>
                        </div>
                    </div>
