        ...
        <div className="Home">
                    ...
                    <div className="row">
                        <div className="col-12">
                            <p className="home-description">
                                Welcome to Homeless Connect, the platform bridging the gap between those in need and the generous people willing to help. By uniting communities through acts of kindness, we're making a real difference for homeless individuals.
                            </p>
                        </div>
                    </div>
            ...
            <div className="container-fluid home-container" style={{background: "#FFAC4D"}}>
                <div className="container center-content">
                    ...
                    <div style={{width: "50%"}}>
                        <p className="home-description" style={{ color: 'black' }}> A compassionate and skilled team united to create real change for the homeless community.</p>
                    </div>
                </div>
                <div className="container center-content">
                    <div className="row">
                    ...
                    <div className="row">
                        <div className="col-sm">
                            <div className="faq-card">
                                ...
                                <p className="card-description" style={{width: "95%"}}> Generous donors can upload their items to our marketplace, providing pictures, item categories, and locations. PEH users can then browse and request the items they need. </p>
                            </div>
                        </div>
                        <div className="col-sm">
                            <div className="faq-card">
                                <h2 className="card-title"  style={{color: "black"}}> How can I help as a high schooler? </h2>
                                <p className="card-description" style={{width: "95%"}}> By Signupg up as a volunteer, high schoolers will be able to see current transactions and offer their support in picking up and dropping off donated items.</p>
                            </div>
                        </div>
                    </div>
                </div>
