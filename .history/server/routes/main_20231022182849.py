...
class GetUser(Resource):
    ...
    def post(self):
        ...
        data = {"location": user['location'], 'userType': user['userType']}
...
class ConfirmDelivery(Resource):
    ...
    def post(self):
        ...
        donor_rating = request.json.get('donor_rating')
        donee_rating = request.json.get('donor_rating')
        ...
        update = {
            '$addToSet':{
                'items.$.donor_ratings': donor_rating
            }
        }
        ...
        update = {
            '$addToSet':{
                'items.$.donee_ratings': donee_rating
            }
        }
        user_collection.update_one(user_query, update)
