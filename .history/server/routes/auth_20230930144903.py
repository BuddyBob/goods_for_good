...
class Signup(Resource):
    ...
    def post(self):
        ...
        location = auth.payload['locationInput']
...
class Login(Resource):
    ...
    def post(self):
        ...
        return {'message': 'Successfully Logged in.', 'userType':user['userType'], "access_token":access_token,"refresh_token":refresh_token, 'code': 200}
