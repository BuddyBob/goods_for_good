...
class GetUser(Resource):
    ...
    def post(self):
        ...
        user['date_created'] = datetime.datetime.strftime(user['date_created'], "%Y-%m-%d %H:%M:%S")
        print(user)
        return json.dumps(user, default=dumper, indent=2)
