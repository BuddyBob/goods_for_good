...
class Signup(Resource):
    ...
    def post(self):
        ...
        user = {'email': email, 'password': hashed_password, 'location': location,  'userType': userType, "date_created": date_created, "rating": [5]}
        if userType == "volunteer":
            user['service_hours'] = 0
            user['items_delivered'] = 0
        
        if userType == "donor":
            user['items_donated'] = 0
