          ...
          <div className="row mb-5">
            <div className="container rating-widget col-6">
              <div className="rating-widget-value">
                <h3 className="rating-widget-value-text">{user && user.items_donated !== null ? user.items_donated : 'N/A'}</h3>
              </div>
              <div className="rating-widget-title">
                <div className="rating-widget-title">
                  <h3 className="rating-widget-title-text text-center">Items Donated</h3>
                </div>
              </div>
            </div>
            <div className="container rating-widget col-6">
